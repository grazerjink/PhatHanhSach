...
namespace PhatHanhSach.Data.Infrastructure
{
    public abstract class RepositoryBase<T> : IRepository<T> where T : class
    {
        ...
        protected PhatHanhSachEntities DbContext
        {
        ...
        public virtual IEnumerable<T> GetMulti(Expression<Func<T, bool>> predicate, string[] includes = null)
        {
            ...
            return entities.Set<T>().Where<T>(predicate).AsQueryable<T>();
        }
        ...
        public virtual IEnumerable<T> GetMultiPaging(Expression<Func<T, bool>> predicate, out int total, int index = 0, int size = 20, string[] includes = null)
        {
            ...
            {
                _resetSet = predicate != null ? entities.Set<T>().Where<T>(predicate).AsQueryable() : entities.Set<T>().AsQueryable();
            }
